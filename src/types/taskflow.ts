...
export type HistoryEventType = 'created' | 'started' | 'stage_created' | 'subtask_created' | 'subtask_completed' | 'subtask_reopened' | 'moved_to_review' | 'review_checked' | 'completed' | 'archived' | 'note_created';
